...
typedef struct t_invariant_statement {
   t_axe_label *eval_exp;
   t_axe_label *end_eval_exp;
   t_axe_label *begin_code;
} t_invariant_statement;

typedef struct t_when_stmt {
   t_axe_label *bypass;
   int reg;
} t_when_stmt;
